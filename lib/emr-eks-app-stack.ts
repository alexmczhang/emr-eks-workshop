...
export class EmrEksAppStack extends cdk.Stack {
    ...
    cdk.Tags.of(vpc).add('karpenter.sh/discovery','emr-eks-workshop-new2');    
    ...
    const eksCluster = new Cluster(this, "Cluster", {
      vpc: vpc,
      clusterName: 'emr-eks-workshop-new2',
    ...
    const s3bucket = new Bucket(this, 'bucket', {
      bucketName: 'emr-eks-workshop-new2-'.concat(cdk.Stack.of(this).account),
